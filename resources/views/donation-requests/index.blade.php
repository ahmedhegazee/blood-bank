    ...
    <div class="card-header">
      ...
      <div class="row justify-content-end">
        <form class="form-inline ml-3" id="filter" action="{{route('request.index')}}">
          ...
          <select class="form-control custom-select mr-2" onchange="document.getElementById('filter').submit();"
            name="blood" id="blood">
          ...
          <select class="form-control custom-select" onchange="document.getElementById('filter').submit();" name="city"
            id="city">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <form id="{{'delete'.$record->id}}" action="{{ route('request.destroy',['request'=>$record->id]) }}"
