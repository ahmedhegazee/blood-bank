    ...
    <section class="content">
      ...
      <div class="input-group input-group-sm mr-2">
        ...
        <select class="form-control custom-select" 
          ...
          <a href="{{route('post.create')}}" class="btn btn-primary ml-2"><i class="fas fa-plus"></i> Add Post</a>
        </div>
      <!-- Default box -->
            ...
            <div class="card card-widget">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="{{route('post.edit',['post'=>$post->id])}}" class="btn btn-tool" >
                  ...
                  <a href="{{route('post.destroy',['post'=>$post->id])}}"
                            ...
                            class="btn btn-tool"><i class="fas fa-trash"></i></a>
                                        <form id="{{'delete'.$post->id}}" action="{{ route('post.destroy',['post'=>$post->id]) }}" method="POST" style="display: none;">
                                            @method('delete')
                                        @csrf
                                    </form>
                </div>
